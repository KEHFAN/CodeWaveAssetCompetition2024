...
import com.netease.lowcode.extension.itextpdf.*;
import com.netease.lowcode.extension.structures.*;
import com.netease.lowcode.extension.utils.FileUtils;
import com.netease.lowcode.extension.utils.UploadResponseDTO;
...
public class PdfGenerator {
    ...
    public static void createPDFByJSON() {
        try {
            JSONObject jsonObject = JSONObject.parseObject(PdfUtils.readJson("src/main/resources/pdf.json"));
