...
@Component
public class UploadPatchLocalFileStorageClient implements UploadPatchFileStorageClient {
    private static final Logger LOGGER = LoggerFactory.getLogger(UploadPatchLocalFileStorageClient.class);
    ...
    @Override
    public String type() {
        return UploadPatchConstants.UPLOAD_TYPE_LOCAL;
    }
    ...
    public void download(OutputStream outputStream, String targetPath, Map<String, String> payloads) throws IOException {
        ...
        if (targetFile.exists()) {
            ...
            throw new UploadPatchHttpCodeException(404, UploadPatchErrorCodeEnum.FILE_NOT_EXIST.desc);
        }
    }
